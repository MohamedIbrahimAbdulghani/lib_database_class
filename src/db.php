...
class databaseRule {
    ...
    public function __construct($host, $root, $password, $dbname, $table_name)
    {
        $this->database_connection = mysqli_connect($host, $root, $password, $dbname);
